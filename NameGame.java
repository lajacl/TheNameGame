...
public class NameGame
{
    ...
    char initial; // used to prevent first initial letters clases with song
    int nameStart; // used to show where where anem should begin based on first vowel location
    int i; // iterator for loop creating sub name
        ...
        while(!name.equals("DONE"))
        {
          ...
          "\n If you are done making lyrics enter DONE in all caps.");
          
          // Prevent use of vulgar words in song by blcoking some names
            ...
            if (letter == 'a' || letter == 'e' || letter == 'i' || letter == 'o' || letter == 'u' || letter == 'y')
             ...
             {             
                ...
                case 'B':
                    ...
                    name + ", " + name + " bo " + nameSub + " Banana fanna fo F" + nameSub + 
                    "\nFee fy mo M" + nameSub + ", " + name + "!");                     
                  break;
                case 'f':
                case 'F':
                    JOptionPane.showMessageDialog(null, "~The Name Game~\n\n" + name + "!\n" + 
                    name + ", " + name + " bo B" + nameSub + " Banana fanna fo " + nameSub + 
                    "\nFee fy mo M" + nameSub + ", " + name + "!");                    
                  break; 
                case 'm':
                case 'M':
                    JOptionPane.showMessageDialog(null, "~The Name Game~\n\n" + name + "!\n" + 
                    name + ", " + name + " bo B" + nameSub + " Banana fanna fo F" + nameSub + 
